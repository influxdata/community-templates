...
* **Call the configuration at its new address:**
  * Locate your configuration and open its setup instructions:
  ...
  ![](https://github.com/influxdata/community-templates/blob/master/kafka/images/open_config_setup_instructions.png=500px)

  * Copy Telegraf startup command provided for you (with your configuration's unique address):

  ![](https://github.com/influxdata/community-templates/blob/master/kafka/images/get_remote_command.png=500px)
